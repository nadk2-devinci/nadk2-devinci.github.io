...
export default class TravelAnimation
{
    ...
    async init()
    {
        /* ? Installations after the defining of constants ? */
        ...
        this.splineDisplayExt = SDK3DVerse.extensions.SplinesDisplay;
    ...
    async hideSplines()
    {
        for(const spline of this.splines)
        {
            ...
            await this.engineAPI.setEntityVisibility(parentEntity, false);
        }
    }
    ...
    async showSplines()
    {
        for(const spline of this.splines)
        {
            ...
            await this.engineAPI.setEntityVisibility(parentEntity, true);
        }
    }
    ...
    lookAtOld(entity, target)
    {
        ...
        */
        ...
        // roller coaster
        let outQuat     = quat.create();
        quat.rotationTo(outQuat, this.sdk.utils.neutralDirection, direction);
        return  outQuat;
    }
